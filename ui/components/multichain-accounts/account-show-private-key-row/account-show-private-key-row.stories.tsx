...
export default {
  ...
  parameters: {
    docs: { description: { component:'A component that displays a Private Key row with export functionality.' }},
    controls:{ sort:'alpha' },
  },
  argTypes:{
    account:{ control:'object', description:'The account object containing metadata and options' },
  },
  decorators:[
    (Story) => (
...
const Template: StoryFn<typeof AccountShowPrivateKeyRow> = (args) => <AccountShowPrivateKeyRow {...args} />;

export const Default = Template.bind({});
Default.args = { account: MOCK_ACCOUNT_EOA };
...
HardwareAccount.args = {
  account:{
    ...MOCK_ACCOUNT_EOA,
    metadata:{ ...MOCK_ACCOUNT_EOA.metadata, keyring:{ type:'Hardware' }},
  },
};
...
SnapAccount.args={
  account:{
    ...MOCK_ACCOUNT_EOA,
    metadata:{ ...MOCK_ACCOUNT_EOA.metadata, keyring:{ type:'Snap' }},
}};
